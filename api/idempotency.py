...
class IdempotencyManager:
    ...
    def acquire(self, key: str, ttl: int = 60, stale_after: Optional[int] = None) -> bool:
        ...
        try:
            ...
            # Fail closed: if Redis is unavailable, deny lock acquisition to
            # prevent duplicate processing during outages.
            return False
    ...
    def acquire_http(self, key: str, ttl: int = 3600) -> bool:
        ...
        try:
            ...
            # Returning True (fail open) would bypass idempotency protection
            # during Redis outages, allowing duplicate requests to be processed.
            return False
